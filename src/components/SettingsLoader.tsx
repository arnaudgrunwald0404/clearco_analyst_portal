    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 text-lg font-medium">Loading your workplace parameters...</p>
          <p className="text-gray-500 text-sm mt-2">Preparing your company settings and configuration</p>
        </div>
      </div>
    )
  }
