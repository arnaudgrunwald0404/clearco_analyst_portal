...
INSERT INTO "ActionItem" (
    ...
    "description",
    "assignedTo",
    "assignedBy", -- Target has this but source doesn't
    "dueDate",
    "isCompleted",
    "completedAt",
    "completedBy", -- Target has this but source doesn't
    "priority",
    "category", -- Target has this but source doesn't
    "notes", -- Target has this but source doesn't
    "createdAt",
    "updatedAt",
    "userId",
    "analystId",
...
SELECT 
    ...
    description,
    "assignedTo",
    "assignedTo" as "assignedBy", -- Using assignedTo as assignedBy
    "dueDate",
    ...
    "createdAt",
    "updatedAt",
    "assignedTo" as "userId", -- Using assignedTo as userId
    "analystId",
    'TASK' as "actionType",
